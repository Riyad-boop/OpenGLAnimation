...
public class Normal {
	 ...
	 * product between these to compute the normal; to get the sign right the
...
//	/**
//	 * Constructs a normal vector by taking 5 co-planar points (not co-linear):
//	 * Based on computing two vectors in the plane, then taking the vector cross
//	 * product between these to compute the normal; to get the sign right the
//	 * vectors must be passed in anti-clockwise order.
//	 * 
...
//	 * @param vec5
//	 */
//	public Normal(Vector vec1, Vector vec2, Vector vec3, Vector vec4, Vector vec5) {
//		// we will hard-wire this - it is not pretty or clever, but easily understood.
//		// in theory we should pass in an array of vectors and compute these terms in a
//		// loop!
//		x = (vec1.getY() - vec2.getY()) * (vec1.getZ() + vec2.getZ())
...
//
//	/**
//	 * Constructs a normal vector by taking 6 co-planar points (not co-linear):
//	 * Based on computing two vectors in the plane, then taking the vector cross
//	 * product between these to compute the normal; to get the sign right the
//	 * vectors must be passed in anti-clockwise order.
//	 * @author RIYAD K RAHMAN
...
//	 * @param vec6
//	 */
//	public Normal(Vector vec1, Vector vec2, Vector vec3, Vector vec4, Vector vec5, Vector vec6) {
//		// we will hard-wire this - it is not pretty or clever, but easily understood.
//		// in theory we should pass in an array of vectors and compute these terms in a
//		// loop!
//		x = (vec1.getY() - vec2.getY()) * (vec1.getZ() + vec2.getZ())
